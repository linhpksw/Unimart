                    ...
                    <div class="relative flex justify-end sm:justify-center">
                        ...
                        <nav aria-label="Progress" class="hidden sm:block">
                            <ol role="list" class="flex space-x-4">
                                ...
                                <li class="flex items-center">
                                    <a href="#" aria-current="page" class="text-indigo-600">Billing Information</a>
                ...
                <form class="px-4 pt-16 pb-36 sm:px-6 lg:col-start-1 lg:row-start-1 lg:px-0 lg:pb-16">
                    <div class="mx-auto max-w-lg lg:max-w-none">
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-6 sm:flex sm:items-center sm:justify-between">
                            <button type="submit"
                                    class="w-full rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last sm:ml-6 sm:w-auto">
                                Continue
                            </button>
                            <p class="mt-4 text-center text-sm text-gray-500 sm:mt-0 sm:text-left">You won't be charged
